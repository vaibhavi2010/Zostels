...
<body>
    ...
    <div class="nav">
            ...
            <div class="links">
                ...
                <a href="..\signup\usersign.php">User Login</a>
                <a href="#" class="mainlink">Admin Login</a>
            </div>
        </div>
    <div class="wrap">
    <div class="login">
...
if(isset($_POST['submit'])){
      if(!empty($mail && $pass)){ 
          $select = "SELECT * FROM admin WHERE mail='$mail' and pass='$pass'"; 
          $result = mysqli_query($conn, $select);
          if (mysqli_num_rows($result) > 0) {
              // output data of each row
              while($row = mysqli_fetch_assoc($result)) {
                  session_start();
                  header("location:adminhome/admin_main.php");
              }       
          }
	...
	<div class="s2-htm" id="Sup">
		<form name="f1" action="signup.php" method="POST" onsubmit="return matchpass()">  
   		<div class="head">
                    ...
                    <input id="user" name="user" type="text" class="input" placeholder="Enter Username" required>
                </div>
                <div class="head">
                    <label for="pass" class="label">Password</label>
                    <input id="pass" name="pass" type="password" class="input" data-type="password" placeholder="Enter Password" required>
                ...
                <div class="head">
                    ...
                    <input id="pass1" name="pass1" type="password" class="input" data-type="password" placeholder="Re-enter Password" required>
                </div>
                <div class="head">
                    <label for="code" class="label">Enter Admin Code</label>
                    <input id="code" name="code" type="password" class="input" placeholder="Enter Code" required>
                </div>
                <div class="head">
                    <label for="mail" class="label">Email Address</label>
                    <input id="mail" name="mail" type="text" class="input" placeholder="Enter Email" required>
                </div>
                <div class="head">
